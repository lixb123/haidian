# 方案叙事 / Design Narrative

“海淀智汇·京张星耀：天工星图 AI 城市客厅”把百年京张的交通与创新记忆，转译为下一百年的公共创新基础设施。方案保持“三廊三芯、两翼一环”的总体结构：天问知识廊让技术和城市历史可解释，女娲织网廊让社区、研究与服务可协作，应龙水脉廊让雨洪、微气候和慢行可感知；三廊连接众智园、AI 原点社区和大钟寺三个创新核心。

v1.2 以原创“天工星图城市协议”把核心理念转化为六道可审计闸门：问题登记、数据许可、空间承载、人工接管、90 日复盘、续期或退出。土地、空间、产业、人才、算力、数据、场景与公共价值由此形成逐级放行回路。协议是概念性实施纪律，不是法定规划、政府承诺或既定采购。

设计不把 AI 理解为遍布城市的屏幕或自动决策，而是将其限定为有清楚目的、人工复核和退出机制的公共服务。模型评测、社区共创和气候感知三个近期试点均采用 90 天验证周期，记录基线、运行日志、公众反馈和退出报告。连续无障碍、非数字服务、最小必要数据和结果可申诉是所有场景的共同门槛。年度运行以春季问题榜、夏季开放周、秋季国际交流季和冬季证据与退出日形成闭环；每项成果必须公开责任方、纠偏记录和续期或退出决定。
